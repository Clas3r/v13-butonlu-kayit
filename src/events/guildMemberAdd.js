...
module.exports = async member => {
    ...
    if (kurulus > 604800000) {
        ...
        member.guild.channels.cache.get(config.channels.welcomechannel).send(`${member} Sunucumuza hoş geldin,

Seninle beraber sunucumuz **${member.guild.memberCount}** üye sayısına ulaştı. :tada:

Hesabın __${kuruluş}__ tarihinde (**${zaman}**) önce oluşturulmuş.

Kayıt işleminden sonra ${config.channels.rules} kanalına göz atmayı unutmayın.

Sunucumuza kayıt olmak için soldaki ses kanallarından birine girmelisin!

tagımıza bakmak için ${config.bot.prefix}tag yazabilirsin.
